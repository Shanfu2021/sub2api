...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	agentManagementService := service.ProvideAgentManagementService(agentManagementRepository, userRepository, groupRepository, apiKeyAuthCacheInvalidator, enterpriseManagementRepository, userGroupRateRepository, settingRepository, usageService)
	...
	adminService := service.NewAdminService(userRepository, groupRepository, accountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, agentManagementRepository, enterpriseManagementRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, openAIGatewayService)
