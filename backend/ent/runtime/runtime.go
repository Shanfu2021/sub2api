...
func init() {
	...
	// groupDescSchedulingStrategy is the schema descriptor for scheduling_strategy field.
	groupDescSchedulingStrategy := groupFields[44].Descriptor()
	// group.DefaultSchedulingStrategy holds the default value on creation for the scheduling_strategy field.
	group.DefaultSchedulingStrategy = groupDescSchedulingStrategy.Default.(string)
	// group.SchedulingStrategyValidator is a validator for the "scheduling_strategy" field. It is called by the builders before save.
	group.SchedulingStrategyValidator = groupDescSchedulingStrategy.Validators[0].(func(string) error)
	...
	// usagelogDescAgentUserRateMultiplier is the schema descriptor for agent_user_rate_multiplier field.
	usagelogDescAgentUserRateMultiplier := usagelogFields[27].Descriptor()
	// usagelog.DefaultAgentUserRateMultiplier holds the default value on creation for the agent_user_rate_multiplier field.
	usagelog.DefaultAgentUserRateMultiplier = usagelogDescAgentUserRateMultiplier.Default.(float64)
	// usagelogDescAgentCostRateMultiplier is the schema descriptor for agent_cost_rate_multiplier field.
	usagelogDescAgentCostRateMultiplier := usagelogFields[28].Descriptor()
	// usagelog.DefaultAgentCostRateMultiplier holds the default value on creation for the agent_cost_rate_multiplier field.
	usagelog.DefaultAgentCostRateMultiplier = usagelogDescAgentCostRateMultiplier.Default.(float64)
	// usagelogDescAgentIncome is the schema descriptor for agent_income field.
	usagelogDescAgentIncome := usagelogFields[29].Descriptor()
	// usagelog.DefaultAgentIncome holds the default value on creation for the agent_income field.
	usagelog.DefaultAgentIncome = usagelogDescAgentIncome.Default.(float64)
	...
	// userDescAllocatedConcurrency is the schema descriptor for allocated_concurrency field.
	userDescAllocatedConcurrency := userFields[7].Descriptor()
	// user.DefaultAllocatedConcurrency holds the default value on creation for the allocated_concurrency field.
	user.DefaultAllocatedConcurrency = userDescAllocatedConcurrency.Default.(int)
	// userDescAllocatedRpm is the schema descriptor for allocated_rpm field.
	userDescAllocatedRpm := userFields[8].Descriptor()
	// user.DefaultAllocatedRpm holds the default value on creation for the allocated_rpm field.
	user.DefaultAllocatedRpm = userDescAllocatedRpm.Default.(int)
