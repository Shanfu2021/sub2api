...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		UserInviteRegistrationEnabled:    req.UserInviteRegistrationEnabled,
	...
	payload := dto.SystemSettings{
		...
		UserInviteRegistrationEnabled:          updatedSettings.UserInviteRegistrationEnabled,
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.RegistrationIPLimitEnabled != after.RegistrationIPLimitEnabled {
		changed = append(changed, "registration_ip_limit_enabled")
	}
	...
	if before.UserInviteRegistrationEnabled != after.UserInviteRegistrationEnabled {
		changed = append(changed, "user_invite_registration_enabled")
	}
