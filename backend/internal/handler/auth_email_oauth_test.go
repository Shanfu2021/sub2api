...
func (r *oauthEmailAffiliateRepoStub) CountEligibleBalanceCredits(context.Context, int64, *int64, string) (int, error) {
	panic("unexpected CountEligibleBalanceCredits call")
}
