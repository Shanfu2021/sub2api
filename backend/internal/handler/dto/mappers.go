...
func UserFromServiceShallow(u *service.User) *User {
	...
	return &User{
		...
		PricingDiscountScope:       service.NormalizePromoDiscountScope(u.PricingDiscountScope),
...
func EnterpriseContextFromService(in *service.EnterpriseContext) *EnterpriseContext {
	...
	return &EnterpriseContext{
		...
		PricingFactor:              service.NormalizeEnterpriseMemberPricingFactorForRepo(in.PricingFactor),
		...
		BalanceOverdraftLimit:      in.BalanceOverdraftLimit,
		AllowedGroupIDs:            append([]int64(nil), in.AllowedGroupIDs...),
		GroupRates:                 in.GroupRates,
		MemberGroupRates:           in.MemberGroupRates,
...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		SchedulingStrategy:              g.SchedulingStrategy,
		RPMLimit:                        g.RPMLimit,
...
func PromoCodeFromService(pc *service.PromoCode) *PromoCode {
	...
	return &PromoCode{
		...
		DiscountScope:  service.NormalizePromoDiscountScope(pc.DiscountScope),
		MaxUses:        pc.MaxUses,
