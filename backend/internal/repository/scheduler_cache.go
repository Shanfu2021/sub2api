...
func filterSchedulerExtra(extra map[string]any) map[string]any {
	...
	keys := []string{
		...
		"auto_pause_quota_active",
		"auto_pause_quota_window",
		"auto_pause_quota_threshold",
		"auto_pause_quota_utilization",
		"auto_pause_quota_reset_at",
		"auto_pause_quota_paused_at",
		"auto_pause_quota_recovered_at",
		"auto_pause_quota_next_probe_at",
		"auto_pause_quota_last_probe_at",
		"auto_pause_quota_last_probe_status",
