...
func RegisterAgentManagementRoutes(authenticated *gin.RouterGroup, h *handler.Handlers) {
	agentManagement := authenticated.Group("/agent-management")
	{
		...
		agentManagement.GET("/usage/search-users", h.AgentManagement.SearchUsageUsers)
		agentManagement.GET("/usage/search-api-keys", h.AgentManagement.SearchUsageAPIKeys)
		agentManagement.GET("/usage/search-accounts", h.AgentManagement.SearchUsageAccounts)
		agentManagement.PUT("/children/:id/allocation", h.AgentManagement.UpdateAllocation)
		agentManagement.PUT("/children/:id/notes", h.AgentManagement.UpdateChildNotes)
