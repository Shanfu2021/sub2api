...
func TestEnterpriseManagementRoutesAreRegisteredUnderAuthenticatedUserRoutes(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{http.MethodGet, "/api/v1/enterprise-management/employee-group-defaults"},
		{http.MethodPut, "/api/v1/enterprise-management/employee-group-defaults/:group_id"},
		{http.MethodDelete, "/api/v1/enterprise-management/employee-group-defaults/:group_id"},
