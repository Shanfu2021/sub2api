...
func (s *adminServiceImpl) UpdateUser(ctx context.Context, id int64, input *UpdateUserInput) (*User, error) {
	...
	var raisedRateFloorUserIDs []int64
	...
	if s.authCacheInvalidator != nil {
		...
		if !invalidatedUserAuthCache && (user.Concurrency != oldConcurrency || user.Status != oldStatus || user.Role != oldRole || user.RPMLimit != oldRPMLimit || !sameInt64Set(user.AllowedGroups, oldAllowedGroups) || groupRates != nil) {
