...
const (
	...
	SettingKeyUserInviteRegistrationEnabled    = "user_invite_registration_enabled"    // 是否允许普通用户邀请码通过注册门槛
	...
	SettingKeyContactQRCodeURL            = "contact_qr_code_url"           // 客服/社群二维码图片地址
	...
	SettingKeyMerchantCallbackToken       = "merchant_callback_token"       // 外部商户回调发卡共享密钥
