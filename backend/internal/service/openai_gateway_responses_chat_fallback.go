...
func (s *OpenAIGatewayService) bufferChatCompletionsAsResponses(
	...
	ccResp, usage, err := s.readCCUpstreamJSONResponse(c, resp, func(c *gin.Context, statusCode int, errType, message string) {
		if message == "Failed to read upstream response" {
