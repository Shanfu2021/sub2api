...
const (
	ScheduledTestDecisionNoAction               = "no_action"
	ScheduledTestDecisionEnabled                = "enabled"
	ScheduledTestDecisionDisabledFailure        = "disabled_failure"
	ScheduledTestDecisionDisabledSlowFirstToken = "disabled_slow_first_token"
	ScheduledTestDecisionAutoControlUnavailable = "auto_control_unavailable"
)
...
type ScheduledTestPlan struct {
	...
	AutoSchedulableControl bool       `json:"auto_schedulable_control"`
