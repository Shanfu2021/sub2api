...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	...
	return &PublicSettings{
		...
		SiteName:                         s.getStringOrDefault(settings, SettingKeySiteName, "开发者补给站"),
		SiteLogo:                         settings[SettingKeySiteLogo],
		SiteSubtitle:                     s.getStringOrDefault(settings, SettingKeySiteSubtitle, "一群程序员共建的便捷 AI API 中转站"),
...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeySiteName:                                 "开发者补给站",
		SettingKeySiteSubtitle:                             "一群程序员共建的便捷 AI API 中转站",
		SettingKeySiteLogo:                                 "",
