          ...
          <div class="p-4">
            ...
            <template v-else>
              ...
              <div v-else-if="hasUpdate && isReleaseBuild" class="space-y-2">
                ...
                <button
                  disabled
                  :title="t('version.webUpdateDisabled')"
                  class="flex w-full cursor-not-allowed items-center justify-center gap-2 rounded-lg bg-primary-500 px-4 py-2 text-sm font-medium text-white opacity-95"
                >
                  <Icon name="download" size="sm" :stroke-width="2" />
                  {{ t('version.updateNow') }}
                </button>
                <p class="text-center text-xs text-gray-500 dark:text-dark-400">
                  {{ t('version.webUpdateDisabledHint') }}
                </p>
