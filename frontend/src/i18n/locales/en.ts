export default {
  ...
  auth: {
    ...
    promoCodeValidWithDiscount: 'Valid! Your special rate will be {factor}x',
    promoCodeValidWithBonusAndDiscount: 'Valid! You will receive ${amount} bonus balance and a {factor}x special rate',
  ...
  redeem: {
    ...
    needToBuyTitle: "Don't have a redeem code yet?",
    needToBuyDesc: 'Buy a balance redeem code first, then come back here and redeem it to credit your account.',
    buyNow: 'Buy Balance Card',
    buyExternalHint: 'Opens the purchase page in a new tab',
    buyInternalHint: 'Redirects to the in-site purchase page',
    productSectionTitle: 'Buy Universal Balance Cards',
    productSectionDesc: 'After purchase, copy the redeem code and enter it above to add balance.',
    productStoreNoticeTitle: 'LianDong Store',
    productStoreNoticeDesc: 'The cards above highlight common balance cards. You can also open the full LianDong store page to browse everything.',
    viewAllProducts: 'View All Products',
    buyThisProduct: 'View Product',
    productCategoryBalance: 'Balance',
    productCategorySubscription: 'Subscription',
    productBalanceTitle: 'Universal Balance Card',
    productBalanceDesc: 'Best for pay-as-you-go top-ups. Purchase first, then redeem the code to credit account balance.',
    productBalancePrice: 'Face value is issued in USD credits',
    productBalanceNote: 'For example, a face value of 10 credits 100 USD in your account. Payment fees do not change the credited amount.',
    productBalanceBadge: 'Balance',
    productSubscriptionTitle: 'Subscription Card',
    productSubscriptionDesc: 'Best for recurring usage. Redeem the purchased code to activate the matching subscription plan or duration.',
    productSubscriptionPrice: 'Purchase according to the plan shown in the store',
    productSubscriptionNote: 'Different products may correspond to different plans or validity periods. Please refer to the product page.',
    productSubscriptionBadge: 'Subscription',
    ...
    promoCodeHint: 'Use this if you received a special pricing promo code',
    applyingPromo: 'Applying...',
    applyPromoButton: 'Apply Promo Code',
    promoBonusApplied: 'Bonus credited',
    promoDiscountApplied: 'Special rate applied: {factor}x',
  ...
  admin: {
    ...
    accounts: {
	  ...
	  autoPauseThresholdHint: 'Leave empty or set 0 to use the global default threshold (configured in Ops settings); set a value to override the global default. Reaching the threshold temporarily pauses the account until the window reset; 7d resets are probed before recovery.',
    ...
    promo: {
      ...
      discountScopeAll: 'Apply to balance and subscriptions',
      discountScopeBalance: 'Balance only',
      discountScopeSubscription: 'Subscriptions only',
      maxUses: 'Max Uses',
    ...
    ops: {
      ...
      settings: {
        ...
        openaiQuotaAutoPauseHint: 'When an OpenAI OAuth account reaches its 5h / 7d usage threshold, it is temporarily paused until the window reset. After a 7d reset, a low-concurrency probe confirms recovery before the account returns to scheduling. Per-account thresholds take precedence over this global default.',
