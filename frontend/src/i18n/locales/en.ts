export default {
  ...
  auth: {
    ...
    errors: {
      ...
      INVITATION_AGENT_QUOTA_INSUFFICIENT: 'The invitation code is valid, but the upstream agent does not have enough remaining concurrency or RPM.',
    },
  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        schedulingStrategy: 'Account Scheduling Strategy',
