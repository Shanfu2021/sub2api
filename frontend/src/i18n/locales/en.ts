export default {
  ...
  redeem: {
    ...
    productSectionTitle: 'Products Available Here',
    productSectionDesc: 'After purchase, copy the redeem code and enter it above to add balance or activate a subscription.',
    productStoreNoticeTitle: 'Browse the full store as well',
    productStoreNoticeDesc: 'The cards above highlight our most common products. You can also open the full LianDong store page to browse everything.',
    viewAllProducts: 'View All Products',
    buyThisProduct: 'View Product',
    productCategoryBalance: 'Balance',
    productCategorySubscription: 'Subscription',
    productBalanceTitle: 'Balance Card',
