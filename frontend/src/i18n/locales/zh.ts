export default {
  ...
  agentManagement: {
    direct: {
      ...
      deleteChildConfirm: "确定删除直属下级 '{email}' 吗？删除后会按角色规则处理其归属。",
      ...
      deleteUserConfirm: "确定真正删除直属用户 '{email}' 吗？",
      userDeleted: '直属用户已删除',
      loadFailed: '加载直属下级失败'
    },
    groups: {
      ...
      manageInviteDefaults: '注册默认分组',
      inviteDefaultsTitle: '邀请码注册默认分组',
      emptyDelegable: '暂无可传播的专属分组',
      childRate: '下级倍率',
      inviteDefaultRate: '注册倍率',
      ...
      removeFailed: '收回分组失败',
      inviteDefaultGroupSaved: '注册默认分组已保存',
      inviteDefaultGroupRemoved: '注册默认分组已移除',
      inviteDefaultGroupFailed: '保存注册默认分组失败',
      inviteDefaultGroupRemoveFailed: '移除注册默认分组失败',
