export default {
  ...
  redeem: {
    ...
    productSectionTitle: '在这里购买商品',
    productSectionDesc: '购买成功后复制兑换码，回到上方输入即可到账或开通订阅。',
    productStoreNoticeTitle: '也可以直接逛整店',
    productStoreNoticeDesc: '上方是我们推荐的常用商品，想看全部商品可以直接进入链动小铺店铺首页。',
    viewAllProducts: '查看全部商品',
    buyThisProduct: '查看并购买',
    productCategoryBalance: '余额兑换',
    productCategorySubscription: '订阅兑换',
    productBalanceTitle: '余额卡',
